    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-lg mx-auto px-5 py-8 sm:px-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m8 12 3 3 5-5"/></svg>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg>
            <span className="text-[15px] font-semibold">Ladder</span>
            <span className="text-[12px] text-muted-foreground">Compete & rank</span>
          </button>
        </div>

        <div key={active} className="text-center py-8 space-y-4 animate-fade-in-up">
          ...
          <button
            onClick={() => router.push(active === "pickup" ? "/pickup" : "/ladder")}
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-green-600 hover:bg-green-700 text-white text-[14px] font-medium transition-colors"
          >
