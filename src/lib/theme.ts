...
export const theme = {
  ...
  doubles: {
    ...
    cardActive: "border-amber-400 bg-amber-50 dark:bg-amber-950/20",
    button: "bg-amber-600 hover:bg-amber-700 text-white",
    buttonOutline: "border-amber-300 text-amber-700 hover:bg-amber-50 hover:border-amber-400",
    accent: "text-amber-600",
    accentBold: "text-amber-600 font-bold",
    badge: "text-amber-700 bg-amber-50 border-amber-200",
    rowHighlight: "bg-amber-50/60 hover:bg-amber-50",
    rowExpanded: "bg-amber-100/80",
    rowDetail: "bg-amber-50/40",
    dot: "bg-amber-500",
    toggle: "bg-amber-600",
  },
